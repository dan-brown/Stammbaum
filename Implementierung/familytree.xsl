      ...
      <body>
        <div id="bodydiv">
          ...
          <nav>
            <!-- Evtl. Navigation Bar -->
            <ul id="menu">
              <li id="menu_item"><a id="menu_link_selected" href="familytree_1.xml">Home</a></li>
              <li id="menu_item"><a id="menu_link" href="familytree_1.xml">Tooooooood</a></li>
              <li id="menu_item"><a id="menu_link" href="familytree_1.xml">oder so</a></li>
